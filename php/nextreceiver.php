...
<div class="main-div">
    <h2 class="title text-center">List of Receiver</h1>
...
$selectquery="select * from receiver";
...
while($res=mysqli_fetch_array($query))
{
    ...
    <td><a href="updatereceiver.php?id=<?php echo $res['id']?>"> <data-toggle="tooltip" data-placement="top" title="UPDATE"> <i class="fa fa-edit" aria-hidden="true"></i></td>
    <td><a href="deleterec.php?idth=<?php echo $res['id']?>"> <data-toggle="tooltip" data-placement="top" title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
