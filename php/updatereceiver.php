...
$ids=$_GET['id'];
$showquery="select * from receiver where id={$ids}";
...
if(isset($_POST['save_data']))
{
  ...
  //$insertquery="insert into donorinfo (name,Date_of_birth,age,bloodgroup,gender,Contact_number,email,address,Covid19_affected) values ('$name','Date_of_birth','$age',$bloodgroup','$gender','$Contact_number','$email','$address','Covid19_affected')";
  $query="update receiver set name='$name',Date_of_birth='$Date_of_birth',age='$age',gender='$gender',bloodgroup='$bloodgroup',Contact_number='$Contact_number',address='$address',Covid19_affected='$Covid19_affected' where id=$idupdate";
