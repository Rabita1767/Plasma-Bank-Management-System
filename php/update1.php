...
<form action="" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="Contact_number"  class="form-control" minlength="14" maxlength="14" id="Contact_number" value="<?php echo $arrdata['Contact_number']?>" placeholder="Contact Number">
  </div>
  <div class="form-group">
